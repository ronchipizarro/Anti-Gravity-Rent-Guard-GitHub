                ...
                <div className="max-w-6xl mx-auto space-y-8">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <a href={MARKETING_URL} className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-gray-300 hover:bg-white/10 text-sm transition-all">
                                <Home size={14} /> Home
                            </a>
                        </div>
                    </div>
